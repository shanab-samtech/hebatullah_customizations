...
def get_columns(invoice_list, additional_table_columns, include_payments=False):
	...
	if not include_payments:
		columns += [
			...
			{"label": _("Tax Id"), "fieldname": "tax_id", "fieldtype": "Data", "width": 80,"hidden": 1,},
			{
			...
			{"label": _("Owner"), "fieldname": "owner", "fieldtype": "Data", "width": 100,"hidden": 1,},
			{
				"label": _("Sales Order"),
		...
		columns += [
			...
			{"fieldname": "debit", "label": _("Debit"), "fieldtype": "Currency", "width": 120,"hidden": 1},
			{"fieldname": "credit", "label": _("Credit"), "fieldtype": "Currency", "width": 120,"hidden": 1},
			{"fieldname": "balance", "label": _("Balance"), "fieldtype": "Currency", "width": 120,"hidden": 1},
		]
